...
export class LoginComponent extends RestController implements OnInit,OnDestroy{
    ...
    constructor(public router:Router, public http:Http, public myglobal:globalService,public af: AngularFire,private routeActive: ActivatedRoute,public toastyService:ToastyService) {
