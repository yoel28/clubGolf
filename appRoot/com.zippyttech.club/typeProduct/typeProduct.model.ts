...
export class TypeProductModel extends ModelBase{
    public rules={};
    ...
    initRules(){
        ...
        this.rules['type']={
            ...
            'placeholder':'Tipo',
            'source':[
                {'value':true,'text': 'Unidad', 'class': 'btn btn-sm btn-green'},
                {'value':false,'text': 'Tiempo', 'class': 'btn btn-sm btn-red'},
            ]
        };
        this.rules['minPrice']={
            'type':'number',
    ...
    initRuleObject() {
        ...
        this.ruleObject.key="typeProduct";
        this.ruleObject.keyDisplay = "typeProductTitle";
        this.ruleObject.code = "typeProductId";
    }
    initRulesSave() {
